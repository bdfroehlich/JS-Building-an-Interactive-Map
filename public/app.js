...
const polygon = L.polygon(latlngs, {color: 'blue', fillOpacity: 0.0, weight: 4}).addTo(myMap);

// create red pin marker
const redPin = L.icon({
    iconUrl: './assets/red-pin.png',
    iconSize: [38,38], //size of icon
    iconAnchor: [19,38], //point of icon that corresponds to marker's location
    popupAnchor: [0,-38] //point from hich the popup should open relative to iconAnchor
})
